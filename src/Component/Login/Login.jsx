...
const Login = () => {
    ...
    return (
        <div className="flex   justify-center  items-center min-h-screen font-Mulish w-full bg-cover" style={{ backgroundImage: `url(https://i.ibb.co/crsRSBt/2150799631.jpg)` }}>
            <Helmet>
            ...
            <div className="flex justify-center  items-center min-h-screen">
                <div className="flex text-white flex-col animate__animated animate__zoomIn bg-opacity-5 backdrop-blur-3xl bg-transparent-white  md:w-[450px] p-10 pb-4 pt-2 rounded-xl ">
                    ...
                    <p className="px-6 text-sm text-center text-gray-300">Don't have any acoount?
