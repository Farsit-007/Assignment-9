                    ...
                    <div className='w-full flex justify-start items-center h-screen bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/Rvxp3dD/minimalistic-cabin-blending-into-environment.jpg)` }} >
                        <div className='w-[80%] mx-auto flex gap-12 items-center'>
                            ...
                            <div>
                                ...
                                <div data-aos="fade-left" data-aos-duration="10000" className=' md:w-[520px] md:h-36 p-4  rounded-xl bg-opacity-5 backdrop-blur-3xl bg-transparent-white'>
                                ...
                                <Link to={'/data/009'}><button className='border mt-5 rounded-lg bg-transparent border-white py-2 px-4 font-bold text-white flex gap-1 items-center hover:bg-slate-700 transition-all duration-1000'>More Details <IoIosArrowForward size={25} /></button></Link>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <div className='w-full flex justify-start items-center h-screen bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/jHtxN71/photorealistic-wooden-house-with-timber-structure.jpg)` }} >
                        <div className='w-[80%] mx-auto flex gap-12 items-center'>
                            ...
                            <div>
                                <div className='py-4'>
                                    <h1 className='text-5xl text-white  font-extrabold'>Apartment</h1>
                                </div>
                                <div data-aos="fade-left" data-aos-duration="6000" className=' md:w-[520px] md:h-36 p-4  rounded-xl bg-opacity-5 backdrop-blur-3xl bg-transparent-white'>
                                ...
                                <Link to={'/data/003'}><button className='border mt-5 rounded-lg bg-transparent border-white py-2 px-4 font-bold text-white flex gap-1 items-center hover:bg-slate-700 transition-all duration-1000'>More Details <IoIosArrowForward size={25} /></button></Link>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                    ...
                    <div className='w-full flex justify-start items-center h-screen bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/8gKd2RK/3d-rendering-house-model.jpg)` }} >
                        <div className='w-[80%] mx-auto flex gap-12 items-center'>
                            ...
                            <div>
                                ...
                                <Link to={'/data/002'}><button className='border mt-5 rounded-lg bg-transparent border-white py-2 px-4 font-bold text-white flex gap-1 items-center hover:bg-slate-700 transition-all duration-1000'>More Details <IoIosArrowForward size={25} /></button></Link>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
